...
This project is a very simple project, it is recommended to use docker to run. However, if you don't want to use docker to run, you can refer to [this page](https://github.com/xinnan-tech/mcp-endpoint-server/blob/main/README_dev.md) to run with source code. The following is the docker running method
