...
- The model I chose this time is: free ChatGLM, which supports function call
...
3. Check the `Agent` option on the page, in the highlighted `Conversation Agent`, select the voice assistant name you configured in step 1, as shown in the figure, I have configured `ZhIPuAi` and select it.
