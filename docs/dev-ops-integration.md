...
# Model files no longer needed - Chinese-focused ASR services have been removed
```
...
# Notes
Test platform `https://2662r3426b.vicp.fun` uses nginx for reverse proxy. Detailed nginx.conf configuration can be [referenced here](https://github.com/xinnan-tech/xiaozhi-esp32-server/issues/791)
