...
Open this tutorial, [Flash Tool/Web-based Firmware Burning (No IDF Development Environment)](https://ccnphfhqs21z.feishu.cn/wiki/Zpz4wXBtdimBrLk25WdcXzxcnNS).
...
[6. I speak slowly, and Xiaozhi keeps interrupting when I pause](./FAQ.md)

[7. I want to control lights, air conditioning, remote power on/off and other operations through Xiaozhi](./FAQ.md)
