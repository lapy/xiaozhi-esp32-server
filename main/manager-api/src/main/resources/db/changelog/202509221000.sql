...
CREATE TABLE `ai_agent` (
  ...
  `vllm_model_id` varchar(32) DEFAULT 'VLLM_ChatGLMVLLM' COMMENT 'Visual model identifier',
...
CREATE TABLE `ai_model_config` (
  ...
  `model_code` varchar(50) DEFAULT NULL COMMENT 'Model code (e.g., AliLLM, AliBLTTS)',
...
('Intent_nointent','Intent','nointent','No Intent Recognition',1,0,'{\"type\": \"nointent\"}',NULL,'No Intent Recognition Configuration Instructions:\n1. No intent recognition performed\n2. All conversations directly passed to LLM for processing\n3. No additional configuration required\n4. Suitable for simple conversation scenarios',1,NULL,NULL,NULL,NULL),
('LLM_AliAppLLM','LLM','AliAppLLM','Alibaba Bailian',0,1,'{\"type\": \"AliBL\", \"app_id\": \"your app_id\", \"api_key\": \"your api_key\", \"base_url\": \"https://dashscope.aliyuncs.com/compatible-mode/v1\", \"is_no_prompt\": true, \"ali_memory_id\": false}','https://bailian.console.aliyun.com/?apiKey=1#/api-key','Alibaba Bailian Configuration Instructions:\n1. Visit https://bailian.console.aliyun.com/?apiKey=1#/api-key\n2. Get app_id and api_key\n3. Fill in configuration file',4,NULL,NULL,NULL,NULL),
('LLM_AliLLM','LLM','AliLLM','Alibaba Qwen',0,1,'{\"type\": \"openai\", \"top_k\": 50, \"top_p\": 1, \"api_key\": \"your api_key\", \"base_url\": \"https://dashscope.aliyuncs.com/compatible-mode/v1\", \"max_tokens\": 500, \"model_name\": \"qwen-turbo\", \"temperature\": 0.7, \"frequency_penalty\": 0}','https://bailian.console.aliyun.com/?apiKey=1#/api-key','Alibaba Qwen Configuration Instructions:\n1. Visit https://bailian.console.aliyun.com/?apiKey=1#/api-key\n2. Get API Key\n3. Fill in configuration file，Current configuration uses qwen-turbo model\n4. Supports custom parameters:temperature=0.7, max_tokens=500, top_p=1, top_k=50',3,NULL,NULL,NULL,NULL),
('LLM_ChatGLMLLM','LLM','ChatGLMLLM','Zhipu AI',1,1,'{\"type\": \"openai\", \"api_key\": \"your api_key\", \"base_url\": \"https://open.bigmodel.cn/api/paas/v4/\", \"model_name\": \"glm-4-flash\"}','https://bigmodel.cn/usercenter/proj-mgmt/apikeys','ChatGLM Configuration Instructions:\n1. Visit https://bigmodel.cn/usercenter/proj-mgmt/apikeys\n2. Register and Get API Key\n3. Fill in configuration file',1,NULL,NULL,NULL,NULL),
('LLM_CozeLLM','LLM','CozeLLM','Coze',0,1,'{\"type\": \"coze\", \"bot_id\": \"your_bot_id\", \"user_id\": \"your_user_id\", \"personal_access_token\": \"your_personal_access_token\"}','https://www.coze.cn/open/oauth/pats','Coze Configuration Instructions:\n1. Use Coze platform service\n2. Need bot_id, user_id and personal access token\n3. Requires network connection\nApplication Steps:\n1. Visit https://www.coze.cn/open/oauth/pats\n2. Get personal access token\n3. Manually calculate bot_id and user_id\n4. Fill in configuration file',9,NULL,NULL,NULL,NULL),
('LLM_DeepSeekLLM','LLM','DeepSeekLLM','DeepSeek',0,1,'{\"type\": \"openai\", \"api_key\": \"your api_key\", \"base_url\": \"https://api.deepseek.com\", \"model_name\": \"deepseek-chat\"}','https://platform.deepseek.com/','DeepSeek Configuration Instructions:\n1. Visit https://platform.deepseek.com/\n2. Register and Get API Key\n3. Fill in configuration file',6,NULL,NULL,NULL,NULL),
('LLM_DifyLLM','LLM','DifyLLM','Dify',0,1,'{\"mode\": \"chat-messages\", \"type\": \"dify\", \"api_key\": \"your api_key\", \"base_url\": \"https://api.dify.ai/v1\"}','https://cloud.dify.ai/','Dify Configuration Instructions:\n1. Visit https://cloud.dify.ai/\n2. Register and Get API Key\n3. Fill in configuration file\n4. Supports multiple Conversation Modes: workflows/run, chat-messages, completion-messages\n5. Role definitions set in platform will be invalid, need to set in Dify console\nNote: Recommend using locally deployed Dify Interface, some regions in China may have limited access to public cloud interfaces',7,NULL,NULL,NULL,NULL),
('LLM_DoubaoLLM','LLM','DoubaoLLM','Doubao Large Model',0,1,'{\"type\": \"openai\", \"api_key\": \"your api_key\", \"base_url\": \"https://ark.cn-beijing.volces.com/api/v3\", \"model_name\": \"doubao-pro-32k-functioncall-241028\"}','https://console.volcengine.com/ark/region:ark+cn-beijing/openManagement','Doubao Large Model Configuration Instructions:\n1. Visit https://console.volcengine.com/ark/region:ark+cn-beijing/openManagement\n2. Enable Doubao-1.5-pro service\n3. Visit https://console.volcengine.com/ark/region:ark+cn-beijing/apiKey Get API Key\n4. Fill in configuration file\n5. Currently recommend using doubao-1-5-pro-32k-250115\nNote: Has free quota of 500000 tokens',5,NULL,NULL,NULL,NULL),
('LLM_FastgptLLM','LLM','FastgptLLM','FastGPT',0,1,'{\"type\": \"fastgpt\", \"api_key\": \"fastgpt-xxx\", \"base_url\": \"https://host/api/v1\", \"variables\": {\"k\": \"v\", \"k2\": \"v2\"}}','https://cloud.tryfastgpt.ai/account/apikey','FastGPT Configuration Instructions:\n1. Use FastGPT platform service\n2. Requires network connection\n3. Prompts in configuration file are invalid, need to set in FastGPT console\n4. Supports custom Variables\nApplication Steps:\n1. Visit https://cloud.tryfastgpt.ai/account/apikey\n2. Get API Key\n3. Fill in configuration file',11,NULL,NULL,NULL,NULL),
('LLM_GeminiLLM','LLM','GeminiLLM','Google Gemini',0,1,'{\"type\": \"gemini\", \"api_key\": \"your api_key\", \"http_proxy\": \"\", \"model_name\": \"gemini-2.0-flash\", \"https_proxy\": \"\"}','https://aistudio.google.com/apikey','Gemini Configuration Instructions:\n1. Use Google Gemini API service\n2. Current configuration uses gemini-2.0-flash model\n3. Requires network connection\n4. Supports proxy configuration\nApplication Steps:\n1. Visit https://aistudio.google.com/apikey\n2. Create API Key\n3. Fill in configuration file\nNote: If using within China, please comply with the Interim Measures for the Management of Generative Artificial Intelligence Services',8,NULL,NULL,NULL,NULL),
('LLM_LMStudioLLM','LLM','LMStudioLLM','LM Studio',0,1,'{\"type\": \"openai\", \"api_key\": \"lm-studio\", \"base_url\": \"http://localhost:1234/v1\", \"model_name\": \"deepseek-r1-distill-llama-8b@q4_k_m\"}','https://lmstudio.ai/','LM Studio Configuration Instructions:\n1. Use locally deployed LM Studio service\n2. Current configuration uses deepseek-r1-distill-llama-8b@q4_k_m model\n3. Local inference, no network connection required\n4. Need to download models in advance\nDeployment Steps:\n1. Install LM Studio\n2. Download models from community\n3. Ensure service runs on http://localhost:1234/v1',10,NULL,NULL,NULL,NULL),
('LLM_OllamaLLM','LLM','OllamaLLM','Ollama Local Model',0,1,'{\"type\": \"ollama\", \"base_url\": \"http://localhost:11434\", \"model_name\": \"qwen2.5\"}','https://ollama.com/','Ollama Configuration Instructions:\n1. Install Ollama service\n2. Run command: ollama pull qwen2.5\n3. Ensure service runs on http://localhost:11434',2,NULL,NULL,NULL,NULL),
('LLM_VolcesAiGatewayLLM','LLM','VolcesAiGatewayTTS','Volcano Engine Edge Large Model Gateway',0,1,'{\"type\": \"openai\", \"api_key\": \"your_gateway_access_key\", \"base_url\": \"https://ai-gateway.vei.volces.com/v1\", \"model_name\": \"doubao-pro-32k-functioncall\"}','https://console.volcengine.com/vei/aigateway/','Volcano Engine Edge Large Model Gateway LLM Configuration Instructions:\n1. Use Volcano Engine Edge Large Model Gateway service\n2. Need gateway access key\n3. Requires network connection\n4. Supports function_call functionality\nApplication Steps:\n1. Visit https://console.volcengine.com/vei/aigateway/\n2. Create gateway access key, search and select Doubao-pro-32k-functioncall\n3. If using speech synthesis, also select Doubao-speech synthesis\n4. Visit https://console.volcengine.com/vei/aigateway/tokens-list to get key\n5. Fill in configuration file',14,NULL,NULL,NULL,NULL),
('LLM_XinferenceLLM','LLM','XinferenceLLM','Xinference Large Model',0,1,'{\"type\": \"xinference\", \"base_url\": \"http://localhost:9997\", \"model_name\": \"qwen2.5:72b-AWQ\"}','https://github.com/xorbitsai/inference','Xinference Configuration Instructions:\n1. Use locally deployed Xinference service\n2. Current configuration uses qwen2.5:72b-AWQ model\n3. Local inference, no network connection required\n4. Need to start corresponding model in advance\nDeployment Steps:\n1. Install Xinference\n2. Start service and load model\n3. Ensure service runs on http://localhost:9997',12,NULL,NULL,NULL,NULL),
('LLM_XinferenceSmallLLM','LLM','XinferenceSmallLLM','Xinference Small Model',0,1,'{\"type\": \"xinference\", \"base_url\": \"http://localhost:9997\", \"model_name\": \"qwen2.5:3b-AWQ\"}','https://github.com/xorbitsai/inference','Xinference Small Model Configuration Instructions:\n1. Use locally deployed Xinference service\n2. Current configuration uses qwen2.5:3b-AWQ model\n3. Local inference, no network connection required\n4. Used for intent recognition\nDeployment Steps:\n1. Install Xinference\n2. Start service and load model\n3. Ensure service runs on http://localhost:9997',13,NULL,NULL,NULL,NULL),
('Memory_mem_local_short','Memory','mem_local_short','Local Short Memory',0,1,'{\"llm\": \"LLM_ChatGLMLLM\", \"type\": \"mem_local_short\"}',NULL,'Local Short Memory Configuration Instructions:\n1. Use local storage to save conversation history\n2. Summarize conversation content through selected_module LLM\n3. Data saved locally, not uploaded to server\n4. Suitable for privacy-focused scenarios\n5. No additional configuration required',2,NULL,NULL,NULL,NULL),
('Memory_mem0ai','Memory','mem0ai','Mem0AI Memory',0,1,'{\"type\": \"mem0ai\", \"api_key\": \"your api_key\"}','https://app.mem0.ai/dashboard/api-keys','Mem0AI Memory Configuration Instructions:\n1. Use Mem0AI service to save conversation history\n2. Need API Key\n3. Requires network connection\n4. 1000 free calls per month\nApplication Steps:\n1. Visit https://app.mem0.ai/dashboard/api-keys\n2. Get API Key\n3. Fill in configuration file',3,NULL,NULL,NULL,NULL),
('Memory_nomem','Memory','nomem','No Memory',1,1,'{\"type\": \"nomem\"}',NULL,'No Memory Configuration Instructions:\n1. Do not save conversation history\n2. Each conversation is independent\n3. No additional configuration required\n4. Suitable for high privacy requirement scenarios',1,NULL,NULL,NULL,NULL),
...
('VLLM_ChatGLMVLLM','VLLM','ChatGLMVLLM','ChatGLM Vision AI',1,1,'{\"type\": \"openai\", \"api_key\": \"your_api_key\", \"base_url\": \"https://open.bigmodel.cn/api/paas/v4/\", \"model_name\": \"glm-4v-flash\"}','https://bigmodel.cn/usercenter/proj-mgmt/apikeys','ChatGLM Vision AI Configuration Instructions:\n1. Visit https://bigmodel.cn/usercenter/proj-mgmt/apikeys\n2. Register and get API key\n3. Fill in configuration file',1,NULL,NULL,NULL,NULL),
('VLLM_QwenVLVLLM','VLLM','QwenVLVLLM','Qwen Vision Model',0,1,'{\"type\": \"openai\", \"api_key\": \"your api_key\", \"base_url\": \"https://dashscope.aliyuncs.com/compatible-mode/v1\", \"model_name\": \"qwen2.5-vl-3b-instruct\"}','https://bailian.console.aliyun.com/?tab=api#/api/?type=model&url=https%3A%2F%2Fhelp.aliyun.com%2Fdocument_detail%2F2845564.html&renderType=iframe','Qwen Vision Model Configuration Instructions:\n1. Visit https://bailian.console.aliyun.com/?tab=model#/api-key\n2. Register and Get API Key\n3. Fill in configuration file',2,NULL,NULL,NULL,NULL);
...
('SYSTEM_ASR_VoskASR','ASR','vosk','VOSK Offline Speech Recognition','[{\"key\": \"model_path\", \"type\": \"string\", \"label\": \"Model Path\"}, {\"key\": \"output_dir\", \"type\": \"string\", \"label\": \"Output Directory\"}]',11,1,'2025-09-25 15:16:45',1,'2025-09-25 15:16:45'),
...
('SYSTEM_LLM_AliBL','LLM','AliBL','Alibaba Bailian Interface','[{\"key\": \"base_url\", \"type\": \"string\", \"label\": \"Base URL\"}, {\"key\": \"app_id\", \"type\": \"string\", \"label\": \"Application ID\"}, {\"key\": \"api_key\", \"type\": \"string\", \"label\": \"API Key\"}, {\"key\": \"is_no_prompt\", \"type\": \"boolean\", \"label\": \"Disable Local Prompt\"}, {\"key\": \"ali_memory_id\", \"type\": \"string\", \"label\": \"Memory ID\"}]',2,1,'2025-06-05 16:53:45',1,'2025-06-05 16:53:45'),
('SYSTEM_LLM_coze','LLM','coze','Coze Interface','[{\"key\": \"bot_id\", \"type\": \"string\", \"label\": \"Bot ID\"}, {\"key\": \"user_id\", \"type\": \"string\", \"label\": \"User ID\"}, {\"key\": \"personal_access_token\", \"type\": \"string\", \"label\": \"Personal Access Token\"}]',6,1,'2025-06-05 16:53:45',1,'2025-06-05 16:53:45'),
...
('SYSTEM_PLUGIN_WEATHER','Plugin','get_weather','Weather Query','[{\"key\": \"api_key\", \"type\": \"string\", \"label\": \"Weather Plugin API Key\", \"default\": \"a861d0d5e7bf4ee1a83d9a9e4f96d4da\"}, {\"key\": \"default_location\", \"type\": \"string\", \"label\": \"Default Query City\", \"default\": \"Guangzhou\"}, {\"key\": \"api_host\", \"type\": \"string\", \"label\": \"Developer API Host\", \"default\": \"mj7p3y7naa.re.qweatherapi.com\"}]',10,0,'2025-09-25 15:16:45',0,'2025-09-25 15:16:45'),
...
(113,'server.mcp_endpoint','null','string',1,'MCP endpoint address',NULL,NULL,NULL,NULL),
(114,'server.voice_print','null','string',1,'Voice print interface address',NULL,NULL,NULL,NULL),
(115,'server.voiceprint_similarity_threshold','0.4','string',1,'Voice print recognition similarity threshold, range 0.0-1.0, default 0.4, higher values are more strict',NULL,NULL,NULL,NULL),
(116,'server.mqtt_gateway','null','string',1,'MQTT gateway configuration',NULL,NULL,NULL,NULL),
(117,'server.mqtt_signature_key','null','string',1,'MQTT signature key configuration',NULL,NULL,NULL,NULL),
(118,'server.udp_gateway','null','string',1,'UDP gateway configuration',NULL,NULL,NULL,NULL),
(119,'server.mqtt_manager_api','null','string',1,'MQTT gateway management API address',NULL,NULL,NULL,NULL),
...
(310,'wakeup_words','Hello Xiaozhi;Hello Xiaozhi;Xiaoai;Hello Xiaoxin;Hello Xiaoxin;Xiaomei;Xiaolong Xiaolong;Miaomiao;Xiaobin Xiaobin;Xiaobing Xiaobing;Hey Hello','array',1,'Wake-up word list for wake-up word recognition',NULL,NULL,NULL,NULL),
