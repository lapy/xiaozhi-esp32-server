...
*   **AI Core Processing (within `xiaozhi-server`):**
    ...
    *   **ASR (Automatic Speech Recognition):** Detected valid speech segments are sent to the configured ASR provider (local or cloud-based, depending on your deployment). The ASR engine converts audio signals into text strings.
