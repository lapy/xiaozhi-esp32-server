"""
TTS reporting functionality has been integrated into ConnectionHandler class.

Reporting functionality includes:
1. Each connection object has its own reporting queue and processing thread
2. Reporting thread lifecycle is bound to connection object
3. Use ConnectionHandler.enqueue_tts_report method for reporting

For specific implementation, please refer to related code in core/connection.py.
"""
