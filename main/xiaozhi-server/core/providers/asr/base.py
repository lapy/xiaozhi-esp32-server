        ...
        try:
            ...
            def run_asr():
                ...
                try:
                    ...
                    try:
                        ...
                        logger.bind(tag=TAG).info(f"ASR processing time: {end_time - start_time:.3f}s")
                        return result
                    finally:
                        loop.close()
                except Exception as e:
            ...
            def run_voiceprint():
                ...
                try:
                    ...
                    asyncio.set_event_loop(loop)
                    try:
                        # Use connected voiceprint recognition provider
                        result = loop.run_until_complete(
        ...
        try:
            ...
            for i, opus_packet in enumerate(opus_data):
                try:
                    ...
                    logger.bind(tag=TAG).warning(f"Opus decoding error, skip packet {i}: {e}")
                except Exception as e:
