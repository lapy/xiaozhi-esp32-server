...
class VADProvider(VADProviderBase):
    def __init__(self, config):
        ...
        # Minimum frames required to consider as voice
    ...
    def is_vad(self, conn, opus_packet):
        try:
            ...
            while len(conn.client_audio_buffer) >= 512 * 2:
                ...
                # If sound doesn't fall below minimum value, continue previous state, judge as having voice
                ...
                # If there was voice before but not this time, and time difference from last voice exceeds silence threshold, consider sentence finished
