...
export default {
  ...
  methods: {
    initLocalData() {
      // Clone providers and normalize headers into editable key/value rows.
      ...
      // Seed one empty block when no providers are configured yet.
...
.provider-card {
  ...
  border-left: 4px solid #409EFF; /* Accent stripe */
...
.label-text {
  ...
  font-size: 13px;
  white-space: nowrap;
  line-height: 32px; /* Vertically center the label text */
}
