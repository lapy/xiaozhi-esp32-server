...
export default {
    ...
    methods: {
        ...
        handleSearch() {
            if (!this.selectedDictType) {
                this.$message.warning('Please select dictionary type first')
                return
            }
            this.currentPage = 1
            this.loadDictDataList(this.selectedDictType.id)
        ...
        // Table header cell style class name for selection column
        ...
        // Cell style class name for setting selection list header translation text
