export default {
  ...
  'agentTemplateManagement.fetchTemplateBackendError': 'Không thể lấy mẫu, vui lòng kiểm tra dịch vụ backend',
  'agentTemplateManagement.fetchTemplateFailed': 'Không thể lấy mẫu',
  'chatHistory.deleteAll': 'Xóa tất cả',
  'chatHistory.deleteAllConfirm': 'Bạn có chắc muốn xóa TẤT CẢ phiên trò chuyện? Hành động này không thể hoàn tác.',
  'chatHistory.deleteAllFailed': 'Xóa tất cả phiên trò chuyện thất bại',
  'chatHistory.deleteAllSessions': 'Xóa tất cả phiên',
  'chatHistory.deleteAllSuccess': 'Đã xóa tất cả phiên trò chuyện thành công',
  'chatHistory.deleteConfirm': 'Bạn có chắc muốn xóa phiên trò chuyện này? Hành động này không thể hoàn tác.',
  'chatHistory.deleteFailed': 'Xóa phiên trò chuyện thất bại',
  'chatHistory.deleteSession': 'Xóa phiên',
  'chatHistory.deleteSuccess': 'Đã xóa phiên trò chuyện thành công',
  'chatHistory.sessionCount': '{count} phiên',
  'customDialog.confirmSave': 'Xác nhận lưu',
  'featureManagement.saveError': 'Lưu cấu hình tính năng thất bại',
  'functionDialog.enterValidJson': 'Vui lòng nhập JSON hợp lệ',
  'header.loading': 'Đang tải...',
  'knowledgeBaseManagement.documentsLabel': 'Tài liệu',
  'knowledgeBaseManagement.retrievalTestFailed': 'Kiểm tra truy xuất thất bại',
  'modelConfig.modelConfig': 'Cấu hình mô hình',
  'otaManagement.getFirmwareListFailed': 'Không thể lấy danh sách firmware',
  'otaManagement.invalidFirmwareId': 'ID firmware không hợp lệ',
  'replacementDialog.addTitle': 'Thêm từ thay thế',
  'retrievePassword.confirmPasswordPlaceholder': 'Vui lòng xác nhận mật khẩu',
  'retrievePassword.sendCaptcha': 'Lấy mã xác minh',
  'roleConfig.functionName': 'Tên chức năng:',
  'ttsModel.cloneAudioPath': 'Đường dẫn âm thanh clone',
  'ttsModel.cloneAudioText': 'Văn bản âm thanh clone',
  'ttsModel.enterCloneAudioPath': 'Vui lòng nhập đường dẫn âm thanh clone',
  'ttsModel.enterCloneAudioText': 'Vui lòng nhập văn bản âm thanh clone',
  'ttsModel.getVoiceListFailed': 'Không thể lấy danh sách giọng nói',
  'ttsModel.invalidVoiceId': 'ID giọng nói không hợp lệ',
  'ttsModel.loadVoiceDataFailed': 'Không thể tải dữ liệu giọng nói',
  'ttsModel.saveFailed': 'Lưu thất bại',
  'ttsModel.updateFailed': 'Cập nhật thất bại',
  'voiceClone.audioNotExist': 'Âm thanh không tồn tại',
}
