export default {
  ...
  'agentTemplateManagement.fetchTemplateBackendError': 'Vorlage konnte nicht abgerufen werden, bitte Backend-Dienst prüfen',
  'agentTemplateManagement.fetchTemplateFailed': 'Vorlage konnte nicht abgerufen werden',
  'chatHistory.deleteAll': 'Alle löschen',
  'chatHistory.deleteAllConfirm': 'Möchten Sie wirklich ALLE Chat-Sitzungen löschen? Diese Aktion kann nicht rückgängig gemacht werden.',
  'chatHistory.deleteAllFailed': 'Löschen aller Chat-Sitzungen fehlgeschlagen',
  'chatHistory.deleteAllSessions': 'Alle Sitzungen löschen',
  'chatHistory.deleteAllSuccess': 'Alle Chat-Sitzungen erfolgreich gelöscht',
  'chatHistory.deleteConfirm': 'Möchten Sie diese Chat-Sitzung wirklich löschen? Diese Aktion kann nicht rückgängig gemacht werden.',
  'chatHistory.deleteFailed': 'Löschen der Chat-Sitzung fehlgeschlagen',
  'chatHistory.deleteSession': 'Sitzung löschen',
  'chatHistory.deleteSuccess': 'Chat-Sitzung erfolgreich gelöscht',
  'chatHistory.sessionCount': '{count} Sitzungen',
  'customDialog.confirmSave': 'Speichern bestätigen',
  'featureManagement.saveError': 'Speichern der Funktionskonfiguration fehlgeschlagen',
  'functionDialog.enterValidJson': 'Bitte gültiges JSON eingeben',
  'header.loading': 'Wird geladen...',
  'knowledgeBaseManagement.documentsLabel': 'Dokumente',
  'knowledgeBaseManagement.retrievalTestFailed': 'Abruftest fehlgeschlagen',
  'modelConfig.modelConfig': 'Modellkonfiguration',
  'otaManagement.getFirmwareListFailed': 'Firmware-Liste konnte nicht abgerufen werden',
  'otaManagement.invalidFirmwareId': 'Ungültige Firmware-ID',
  'replacementDialog.addTitle': 'Ersetzungswort hinzufügen',
  'retrievePassword.confirmPasswordPlaceholder': 'Bitte Passwort bestätigen',
  'retrievePassword.sendCaptcha': 'Bestätigungscode abrufen',
  'roleConfig.functionName': 'Funktionsname:',
  'ttsModel.cloneAudioPath': 'Klon-Audio-Pfad',
  'ttsModel.cloneAudioText': 'Klon-Audio-Text',
  'ttsModel.enterCloneAudioPath': 'Bitte Klon-Audio-Pfad eingeben',
  'ttsModel.enterCloneAudioText': 'Bitte Klon-Audio-Text eingeben',
  'ttsModel.getVoiceListFailed': 'Stimmliste konnte nicht abgerufen werden',
  'ttsModel.invalidVoiceId': 'Ungültige Stimm-ID',
  'ttsModel.loadVoiceDataFailed': 'Stimmdaten konnten nicht geladen werden',
  'ttsModel.saveFailed': 'Speichern fehlgeschlagen',
  'ttsModel.updateFailed': 'Aktualisierung fehlgeschlagen',
  'voiceClone.audioNotExist': 'Audio existiert nicht',
}
