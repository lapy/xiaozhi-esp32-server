export default {
  ...
  'agentTemplateManagement.fetchTemplateBackendError': 'Failed to fetch template, please check if the backend service is normal',
  'agentTemplateManagement.fetchTemplateFailed': 'Failed to fetch template',
  ...
  'customDialog.confirmSave': 'Confirm Save',
  'featureManagement.saveError': 'Failed to save feature configuration',
  'functionDialog.enterValidJson': 'Please enter valid JSON',
  'header.loading': 'Loading...',
  'knowledgeBaseManagement.documentsLabel': 'Documents',
  'knowledgeBaseManagement.retrievalTestFailed': 'Retrieval test failed',
  'modelConfig.modelConfig': 'Model Configuration',
  'otaManagement.getFirmwareListFailed': 'Failed to get firmware list',
  'otaManagement.invalidFirmwareId': 'Invalid firmware ID',
  'register.and': 'and',
  'replacementDialog.addTitle': 'Add Replacement Word',
  'retrievePassword.confirmPasswordPlaceholder': 'Please confirm password',
  'retrievePassword.sendCaptcha': 'Get Verification Code',
  'roleConfig.functionName': 'Function Name:',
  'ttsModel.cloneAudioPath': 'Clone Audio Path',
  'ttsModel.cloneAudioText': 'Clone Audio Text',
  'ttsModel.enterCloneAudioPath': 'Please enter clone audio path',
  'ttsModel.enterCloneAudioText': 'Please enter clone audio text',
  'ttsModel.getVoiceListFailed': 'Failed to get voice list',
  ...
  'voiceClone.audioNotExist': 'Audio does not exist',
}
