...
/**
 * SM2 public-key encryption (hex in/out). Prepends 0x04 to match backend expectations.
 */
 ...
 * @param immediate whether to run immediately, defaults to false
...
/**
 * Deep-clone a value.
 * @param target target value to clone
