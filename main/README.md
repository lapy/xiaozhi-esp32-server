...
*   **AI Core Processing (within `xiaozhi-server`):**
    ...
    *   **ASR (Automatic Speech Recognition):** Detected effective speech segments are sent to configured ASR providers (local or cloud-based, depending on your deployment). ASR engines convert audio signals to text strings.
